...
public class LogoutExceptionHandler {
    private static final Logger logger = LoggerFactory.getLogger(LogoutExceptionHandler.class);

    @ExceptionHandler(LogoutException.class)
    public ResponseEntity<Map<String, String>> handleLogoutException(LogoutException ex, WebRequest request) {
